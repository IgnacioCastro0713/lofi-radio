...
# 2. IAM Module - Creates dedicated Service Accounts and grants Roles for PROD
module "iam" {
  source      = "../../modules/iam"
...
# 3. Storage Module - Sets up the GCS bucket and binds access permissions for PROD
module "storage" {
...
# 5. Scheduler Module - Schedules periodic execution of the Worker Job for PROD
module "scheduler" {
...
output "lofi_radio_web_url" {
  ...
  description = "The public web URL of your lofi radio station stream (PROD)!"
}
